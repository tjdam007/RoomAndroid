  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `user_table` (`userId` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"98c82c0b55f6b2ff3c70727d3fb950fb\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsUserTable = new HashMap<String, TableInfo.Column>(2);
        _columnsUserTable.put("userId", new TableInfo.Column("userId", "INTEGER", true, 1));
        _columnsUserTable.put("name", new TableInfo.Column("name", "TEXT", true, 0));
        ...
        if (! _infoUserTable.equals(_existingUserTable)) {
          throw new IllegalStateException("Migration didn't properly handle user_table(room.entity.User).\n"
                  + " Expected:\n" + _infoUserTable + "\n"
                  + " Found:\n" + _existingUserTable);
        }
      }
    }, "98c82c0b55f6b2ff3c70727d3fb950fb");
